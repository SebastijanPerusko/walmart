...
<body class = "bg-light">
  <nav aria-label="Eighth navbar example" class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link m-1" aria-current="page" href="<?php echo site_url('walmart/cart'); ?>"><h2><i class="bi bi-cart-dash"></i></h2></i></a>
      </li>
      ...
      if(isset($_SESSION['logged_in'])){
        ...
        echo ' <li class="nav-item"><a class="nav-link m-1" aria-current="page" href="'.$add_log.'"><i class="bi bi-person-circle"></i><span class = "text-light">'.$name_profile.'</span></a></li>';
      }
      ?>
      ...
      if(!isset($_SESSION['logged_in'])){
        ...
        echo '<li class="nav-item"><a class="nav-link m-1" aria-current="page" href="'.$add.'"><h2><i class="bi bi-arrow-bar-right"></i></h2></a></li>';
      }
      ?>
      ...
      if(isset($_SESSION['logged_in'])){
        ...
        echo '<li class="nav-item"><a class="nav-link m-1" aria-current="page" href="'.$add_log_out.'"><h2><i class="bi bi-box-arrow-right"></i></h2></a></li>';
      }
      ?>
    </ul>
    </div>
