...
<main class="signin_from_main border bg-primary rounded-3">
  ...
  <?php echo form_open('user_authentication/signup'); ?>
    ...
    <h1 class="mb-3 h3 fw-normal text-light">Create account</h1>
    ...
    <hr/>
    <input disabled id ="submit_reg" class="w-100 btn btn-lg btn-light" type="submit" value="Create account " name="submit"/><br /><br />
    <a class="w-100 btn btn-lg btn-light" href="<?php echo base_url() ?>index.php/user_authentication/signin">Click here to login</a>
        <?php echo form_close(); ?>
  </form>
</main>
</div>
