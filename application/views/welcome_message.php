...
<body>
	<div id="container">
		...
		<div id="body">
			<p>Stran, ki si jo ogledujete, generira CodeIgniter dinamično.</p>

			<p>Če želite urediti to stran, jo najdete na naslovu:</p>
			<code>Če želite urediti to stran, jo najdete na naslovu:</code>

			<p>Če želite urediti to stran, jo najdete na naslovu:</p>
			<code>Če želite urediti to stran, jo najdete na naslovu:</code>

			<p>Če želite urediti to stran, jo najdete na naslovu: <a href="user_guide/">User Guide</a>.</p>
		</div>
